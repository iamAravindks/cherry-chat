  ...
  return (
    <section className="min-w-full min-h-screen p-2 flex flex-col justify-center items-center lg:flex-row">
      <div className="w-full min-h-[45vh] flex flex-col  justify-center items-center p-8">
        <img src={Img1} alt="chat at anywhere" className="max-w-[60%] mb-4 md:max-w-[50%]" />
      ...
      <div className="w-full min-h-[45vh] flex flex-col justify-center items-center gap-3">
        <form className="w-full flex flex-col justify-center items-center gap-4 " onSubmit={onSubmitHandler}>
          <input
            type="email"
            placeholder="email"
          ...
          <button type="submit" className="btn btn-primary">
            ...
            <BiLogInCircle className="text-xl" />
              ...
              <h3 className="text-lg font-roboto font-semibold">New here ? &nbsp; <Link to="/signup" className="text-blue-500">Signup to start</Link></h3>
      </div>
    </section>
  );
};
